...
const buildMainContent = (fullStaticPath, pathname) => {
    ...
    items.forEach(item => {
        ...
        mainContent += '<tr data-name="' + itemDetails.name + '" data-size="' + itemDetails.sizeBytes + '" data-time="' + itemDetails.timeStamp + '"><td>' + itemDetails.icon + '<a href="' + link + '">' + item + '</a></td><td>' + itemDetails.size + '</td><td>' + itemDetails.date + '</td></tr>';
    });
